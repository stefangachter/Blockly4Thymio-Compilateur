...
#define MyAppName "Blockly4Thymio.v0.31"
#define MyAppExeName "blockly4thymio.v0.31.exe"
...
[Run]
Filename: wordpad.exe; Parameters: """{app}\LISEZ-MOI.rtf"""; Verb: open; Flags: shellexec runasoriginaluser
...
begin
  if not IsDotNetDetected('v3.0', 0) then begin
